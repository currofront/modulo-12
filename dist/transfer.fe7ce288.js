...
var insertTransfer = function insertTransfer(transfer) {
  return _axios.default.post(url + '/' + transfer.id, transfer).then(function (response) {
    return response.data;
  });
};
...
(0, _transfer4.getAccountList)(params.id).then(function (accountList) {
...
(0, _helpers.onUpdateField)('select-account', function (event) {
  ...
  _transfer.formValidation.validateField('select-account', transfer.account).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _transfer.formValidation.validateField('notes', transfer.notes).then(function (result) {
...
var onSave = function onSave() {
  var apiTransfer = (0, _transfer3.mapTransferFromViewModelToApi)(transfer);
  return (0, _transfer4.insertTransfer)(apiTransfer);
};
...
},{"../../common/helpers":"common/helpers/index.js","./transfer.validations":"pages/transfer/transfer.validations.js","../../core/router":"core/router/index.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.mappers":"pages/transfer/transfer.mappers.js","./transfer.api":"pages/transfer/transfer.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
