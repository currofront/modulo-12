...
exports.getMovementList = exports.getAccount = void 0;
...
exports.mapMovementApiToViewmodel = void 0;
var mapMovementApiToViewmodel = function mapMovementApiToViewmodel(movementList) {
  return Array.isArray(movementList) ? movementList.map(function (movement) {
    return MovementApiToVm(movement);
  }) : [];
};
exports.mapMovementApiToViewmodel = mapMovementApiToViewmodel;
var MovementApiToVm = function MovementApiToVm(movement) {
  return {
...
(0, _movements.getAccount)(params.id).then(function (account) {
  (0, _helpers.onSetValues)(account);
});
(0, _movements.getMovementList)().then(function (movement) {
  if (movement.accountId === params.id) {
    var vmMovements = (0, _movements3.mapMovementApiToViewmodel)(movement);
    (0, _movements2.addMovementRows)(vmMovements);
  } else {
    var _vmMovements = (0, _movements3.mapMovementApiToViewmodel)(movement).filter(function (movement) {
